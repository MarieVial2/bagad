 ...
 */
final class Version20230221101827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_prestation (id INT AUTO_INCREMENT NOT NULL, nom_prestation VARCHAR(255) DEFAULT NULL, date_prestation DATE NOT NULL, heure_debut_prestation VARCHAR(10) NOT NULL, heure_fin_prestation VARCHAR(10) DEFAULT NULL, type_prestation VARCHAR(255) NOT NULL, informations_prestation LONGTEXT DEFAULT NULL, nb_minimum_sonneurs_prestation INT DEFAULT NULL, email_demandeur_prestation VARCHAR(255) DEFAULT NULL, telephone_demandeur_prestation VARCHAR(14) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
